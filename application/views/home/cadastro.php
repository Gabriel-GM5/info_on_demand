...
<div class="container">
	...
	<div class="row">
		<div class="input-field col s12">
			<?php
			echo form_input(array('id' => "first_name", 'name' => "first_name", 'type' => "text", 'class' => "validate", 'maxlength' => "45"));
	...
	<div class="row">
		<div class="input-field col s12">
			<?php
			echo form_input(array('id' => "last_name", 'name' => "last_name", 'type' => "text", 'class' => "validate", 'maxlength' => "45"));
	...
	<div class="row">
		<div class="input-field col s12">
			<?php
			echo form_input(array('id' => "password", 'name' => "password", 'type' => "password", 'class' => "validate", 'maxlength' => "45"));
	...
	<div class="row">
		<div class="input-field col s12">
			<?php
			echo form_input(array('id' => "confirmPassword", 'name' => "confirmPassword", 'type' => "password", 'class' => "validate", 'maxlength' => "45"));
