...
<div id="modalNovaPostagem" class="modal">
	...
	<div class="modal-content">
		...
		<div class="row">
			<div class="input-field col s12">
				<?php
				echo form_textarea(array('id' => "conteudo", 'name' => "conteudo", 'class' => "validate materialize-textarea", 'value' => set_value('conteudo'), 'required' => "required", 'style' => "min-height:100px;height:100%;"));
