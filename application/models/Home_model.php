...
class Home_model extends CI_Model
{
	...
	{
		if ($termo) {
			$this->db->select('users.first_name as nomeUsuario, users.last_name as sobrenomeUsuario, users.id as idUsuario, posts.id as idPost, posts.titulo, posts.subtitulo, posts.visualizacoes, posts.criacao, posts.ultimaEdicao');
